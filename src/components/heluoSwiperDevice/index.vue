...
:deep(.swiper-item){
  height: 34px!important;/*swiper子项目整体高度，父级继承*/
...
.each-item-text{
  ...
  height: 34px;
  line-height: 34px;
  background: url('@assets/usedimg/k@2x.png') no-repeat center / cover;
  text-indent: 25px;
  &.cur{
    background: url('@assets/usedimg/k_cur@2x.png') no-repeat center / cover;
  }
}
